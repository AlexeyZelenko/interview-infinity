...
const emit = defineEmits(['close', 'update:testData']);
...
const handleSubmit = async () => {
  ...
  try {
    ...
    const docRef = doc(db, 'tests', props.testData.id);
...
<template>
  <div v-if="props.isOpen" class="fixed inset-0 z-50 overflow-y-auto">
    ...
    <div class="flex min-h-screen items-center justify-center p-2">
      <div class="relative w-full max-w-3xl bg-gray-800 rounded-lg shadow-xl">
        <!-- Modal header -->
          ...
          <form @submit.prevent="handleSubmit" class="space-y-6">
            ...
            <div class="space-y-4">
              <div>
                ...
                <input v-model="formData.title" type="text" required class="w-full px-3 py-2 bg-gray-700 rounded-md" />
              </div>
              ...
              <div v-if="formData.questions.length > 0" class="space-y-4">
                ...
                <div v-for="(question, index) in formData.questions" :key="index" class="bg-gray-700 p-4 rounded-lg">
                  ...
                  <div v-if="editableQuestionIndex === index">
                    ...
                    <textarea v-model="editQuestionData.explanation" class="w-full px-3 py-2 bg-gray-700 rounded-md mt-2" placeholder="Explanation (optional)"></textarea>
                  </div>
